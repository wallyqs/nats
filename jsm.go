...
type JetStreamManager interface {
	...
	// NewStreamLister is used to retrieve a list of StreamInfo objects.
...
func (sl *streamLister) Streams() <-chan *StreamInfo {
	ach := make(chan *StreamInfo, 0)
	go func() {
		for sl.Next() {
...
// NewStreamLister is used to return StreamInfo objects.
